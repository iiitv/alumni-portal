...
const aboutSampleText = 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa strong';
        ...
        <Segment>
          ...
          <div className="alumni-info">
            <Container fluid style={containerMargin}>
                ...
                <div className="alumni-profile-desc">
                    ...
                    <h3 className="alumni-designation"> Batch 2020 | Mtech IIT Ropar</h3>
                    <hr />
                    <p> {aboutSampleText} </p>
                </div>
                </div>
          ...
          <div className="alumni-footer">
            <div className="alumni-footer-social">
              <img src="/asset/images/Home/HeaderNFooter/facebook.png" className="social-icon" alt="facebook handle" />
              <img src="/asset/images/Home/HeaderNFooter/linkedin.png" className="social-icon" alt="linkedin handle" />
              <img src="/asset/images/Home/HeaderNFooter/twitter.png" className="social-icon" alt="twitter handle" />
            </div>
